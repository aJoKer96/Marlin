...
#define STRING_CONFIG_H_AUTHOR "JoKer96" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JoKer's 3D Printer"
...
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 100, 500 }
